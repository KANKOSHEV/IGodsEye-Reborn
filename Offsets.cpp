pub const REFDEF: Address = 0x16D46498;
pub const NAME_ARRAY: Address = 0x16D51578;
pub const CAMERA_POINTER: Address = 0x14023700;
pub const LOCAL_INDEX_POINTER: Address = 0x6F228;
pub const NO_RECOIL: Address = 0x2980;
Character Info:
pub const SIZE: Address = 0x3A60;
pub const VALID: Address = 0x94;
pub const POS_PTR: Address = 0xCF8;
pub const TEAM: Address = 0x758;
pub const STANCE: Address = 0xE14;
pub const DEAD_1: Address = 0xA8;
pub const DEAD_2: Address = 0xBB8;
 
client_info:
pub const ENCRYPTED_PTR: Address = 0x16D43B08;
 
client_base:
pub const ENCRYPTED_PTR: Address = 0x9DBC8;
 
bones:
pub const ENCRYPTED_PTR: Address = 0x1AE147A
pub const BASE_POS: Address = 0x5814C;
